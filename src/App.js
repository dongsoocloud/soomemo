    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2"><span className="text-pink-500">秀</span>메모</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                <span className="text-pink-500">秀</span>메모
              </h1>
            </div>
      ...
      {isAuthenticated ? (
        ...
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-12">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Welcome to <span className="text-pink-500">秀</span>메모!</h2>
